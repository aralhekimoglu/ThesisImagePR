...
#SBATCH --job-name=st2_noise18
#SBATCH --output=st2_noise18.out
...
python train.py \
--stage 2 \
--exp-dir /scratch/ahh335/experiments/thesis/stage2/st2_noise18 \
--gen-img-dir ./generated_images/st2_noise18 \
